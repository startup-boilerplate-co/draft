...
<dom-module id="paper-card">
  <template>
    ...
    <div class="header">
      <iron-image hidden$="[[!image]]" src="[[image]]" preload$="[[preloadImage]]" fade$="[[fadeImage]]" sizing$="[[sizingImage]]" position$="[[positionImage]]"></iron-image>
  ...
  <script>
    Polymer({
      ...
      properties: {
        ...
        /**
         * Binds to `iron-image` sizing property. Valid values are contain
         * (full aspect ratio of the image is contained within the element and letterboxed)
        ...
        /**
         * Binds to `iron-image` position property. When a sizing option is used (cover or contain),
